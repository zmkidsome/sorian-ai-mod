...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'Sorian NavalT1AirFactoryUpgrade',
        PlatoonTemplate = 'T1AirFactoryUpgrade',
        Priority = 200,
        InstanceCount = 1,
        FormDebugFunction = nil,
...
BuilderGroup {
    ...
    BuildersType = 'PlatoonFormBuilder',
    Builder {
        BuilderName = 'Sorian Naval T2 Land Factory Upgrade - initial',
        PlatoonTemplate = 'T2LandFactoryUpgrade',
        Priority = 300,
        InstanceCount = 1,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'Sorian Naval T2 Air Factory Upgrade - initial',
        PlatoonTemplate = 'T2AirFactoryUpgrade',
        Priority = 300,
        InstanceCount = 1,
        BuilderConditions = {
...
BuilderGroup {
    BuilderGroupName = 'SorianT1NavalUpgradeBuildersExpansions',
    BuildersType = 'PlatoonFormBuilder',
    Builder {
        BuilderName = 'Sorian T1 Land Factory Upgrade Naval Expansions',
        PlatoonTemplate = 'T1LandFactoryUpgrade',
        Priority = 200,
        InstanceCount = 1,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'Sorian T1AirFactoryUpgrade Naval Expansions',
        PlatoonTemplate = 'T1AirFactoryUpgrade',
        Priority = 200,
        InstanceCount = 1,
        FormDebugFunction = nil,
    ...
    Builder {
        BuilderName = 'Sorian T1 Sea Factory Upgrade Naval Expansions',
        PlatoonTemplate = 'T1SeaFactoryUpgrade',
        Priority = 200,
        InstanceCount = 1,
        BuilderConditions = {
...
BuilderGroup {
    BuilderGroupName = 'SorianT2NavalUpgradeBuildersExpansions',
    BuildersType = 'PlatoonFormBuilder',
    Builder {
        BuilderName = 'Sorian T2 Land Factory Upgrade Naval Expansions',
        PlatoonTemplate = 'T2LandFactoryUpgrade',
        Priority = 300,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'FACTORY TECH3, FACTORY TECH2' } },
    ...
    Builder {
        BuilderName = 'Sorian T2 Air Factory Upgrade Naval Expansions',
        PlatoonTemplate = 'T2AirFactoryUpgrade',
        Priority = 300,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'FACTORY TECH3, FACTORY TECH2' } },
    ...
    Builder {
        BuilderName = 'Sorian T2 Sea Factory Upgrade Naval Expansions',
        PlatoonTemplate = 'T2SeaFactoryUpgrade',
        Priority = 300,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'FACTORY TECH3, FACTORY TECH2' } },
