...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ UCBC, 'FactoryLessAtLocation', { 'LocationType', 4, 'FACTORY AIR TECH2, FACTORY AIR TECH3' }},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            #{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.85, 1.05 }},
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 4, 'FACTORY AIR TECH3' }},
			{ UCBC, 'FactoryLessAtLocation', { 'LocationType', 4, 'FACTORY AIR TECH3' }},
        },
        BuilderType = 'Air',
    },
    Builder {
        ...
        BuilderConditions = {
			...
			{ UCBC, 'HaveUnitsWithCategoryAndAlliance', { true, 8, categories.MOBILE * categories.AIR - categories.SCOUT, 'Enemy'}},
            { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, categories.ANTIAIR * categories.AIR - categories.BOMBER } },
            { IBC, 'BrainNotLowPowerMode', {} },
			{ SBC, 'NoRushTimeCheck', { 600 }},
			{ UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 0, categories.FACTORY * categories.AIR * categories.TECH1 } },
    ...
    Builder {
        ...
        Priority = 560,
        BuilderConditions = {
            { UCBC, 'HaveLessThanUnitsWithCategory', { 35, categories.AIR * categories.ANTIAIR * categories.TECH1 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.85, 1.05 }},
			{ SBC, 'NoRushTimeCheck', { 600 }},
			{ UCBC, 'FactoryLessAtLocation', { 'LocationType', 6, 'FACTORY AIR TECH3' }},
        },
    },
    Builder {
