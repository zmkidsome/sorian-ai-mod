...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                #{ EBC, 'GreaterThanEconStorageRatio', { 0.25, 0.25}},
				{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.9, 1.2 }},
				{ SBC, 'CmdrHasUpgrade', { 'RegenAura', false }},
				{ SBC, 'CmdrHasUpgrade', { 'T3Engineering', false }},
                { MIBC, 'FactionIndex', {4, 4}},
            },
        Priority = 900,
		...
		PlatoonAddFunctions = { {SAI, 'BuildOnce'}, },
        BuilderData = {
            Enhancement = { 'AdvancedEngineering', 'RegenAura' },
        },
    },
    Builder {
		...
		PlatoonAddFunctions = { {SAI, 'BuildOnce'}, },
        BuilderData = {
            Enhancement = { 'AdvancedRegenAura', 'T3Engineering' },
        },
    },
}
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 950,
        BuilderConditions = {
                { UCBC, 'UnitsLessAtLocation', { 'LocationType', 3, 'ENERGYPRODUCTION TECH2' } },
                { UCBC, 'EngineerLessAtLocation', { 'LocationType', 1, 'TECH3 ENGINEER' }},
				{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.5, 0.1 }},
				{ SIBC, 'LessThanEconEfficiencyOverTime', { 2.0, 1.3 }},
				{ SIBC, 'LessThanEconEfficiency', { 2.0, 1.3 }},
				{ SIBC, 'LessThanEconTrend', { 100000, 30}},
            },
        BuilderType = 'Any',
        BuilderData = {
            Construction = {
    ...
    Builder {
        ...
        BuilderType = 'Any',
        BuilderConditions = {
                { UCBC, 'UnitsLessAtLocation', { 'LocationType', 3, 'ENERGYPRODUCTION TECH3' } },
	            { SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.5, 0.1 }},
				{ SIBC, 'LessThanEconEfficiencyOverTime', { 2.0, 1.3 }},
				{ SIBC, 'LessThanEconEfficiency', { 2.0, 1.3 }},
